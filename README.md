...
Проект имеет минимальный функционал для прогнозирования цен на товары, разраничение прав доступа для разных типов пользователей и бесплатный с открытым исходным кодом
